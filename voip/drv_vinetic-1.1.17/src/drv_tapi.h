...
/*  Masks that contain all RX and both bits */
#define IFX_TAPI_SIG_RXMASK (                                              \
           IFX_TAPI_SIG_DIS             | IFX_TAPI_SIG_DISRX             | \
           IFX_TAPI_SIG_CED             | IFX_TAPI_SIG_CEDRX             | \
           IFX_TAPI_SIG_CNGFAX          | IFX_TAPI_SIG_CNGFAXRX          | \
           IFX_TAPI_SIG_CNGMOD          | IFX_TAPI_SIG_CNGMODRX          | \
           IFX_TAPI_SIG_PHASEREV        | IFX_TAPI_SIG_PHASEREVRX        | \
           IFX_TAPI_SIG_AM              | IFX_TAPI_SIG_AMRX              | \
           IFX_TAPI_SIG_TONEHOLDING_END | IFX_TAPI_SIG_TONEHOLDING_ENDRX | \
           IFX_TAPI_SIG_CEDEND          | IFX_TAPI_SIG_CEDENDRX          | \
                                          IFX_TAPI_SIG_V8BISRX           )

#define IFX_TAPI_SIG_EXT_RXMASK (                                          \
           IFX_TAPI_SIG_EXT_V21L        | IFX_TAPI_SIG_EXT_V21LRX        | \
           IFX_TAPI_SIG_EXT_V18A        | IFX_TAPI_SIG_EXT_V18ARX        | \
           IFX_TAPI_SIG_EXT_V27         | IFX_TAPI_SIG_EXT_V27RX         | \
           IFX_TAPI_SIG_EXT_BELL        | IFX_TAPI_SIG_EXT_BELLRX        | \
           IFX_TAPI_SIG_EXT_V22         | IFX_TAPI_SIG_EXT_V22RX         | \
           IFX_TAPI_SIG_EXT_V22ORBELL   | IFX_TAPI_SIG_EXT_V22ORBELLRX   | \
           IFX_TAPI_SIG_EXT_V32AC       | IFX_TAPI_SIG_EXT_V32ACRX       )

/*  Masks that contain all TX and both bits */
#define IFX_TAPI_SIG_TXMASK (                                              \
           IFX_TAPI_SIG_DIS             | IFX_TAPI_SIG_DISTX             | \
           IFX_TAPI_SIG_CED             | IFX_TAPI_SIG_CEDTX             | \
           IFX_TAPI_SIG_CNGFAX          | IFX_TAPI_SIG_CNGFAXTX          | \
           IFX_TAPI_SIG_CNGMOD          | IFX_TAPI_SIG_CNGMODTX          | \
           IFX_TAPI_SIG_PHASEREV        | IFX_TAPI_SIG_PHASEREVTX        | \
           IFX_TAPI_SIG_AM              | IFX_TAPI_SIG_AMTX              | \
           IFX_TAPI_SIG_TONEHOLDING_END | IFX_TAPI_SIG_TONEHOLDING_ENDTX | \
           IFX_TAPI_SIG_CEDEND          | IFX_TAPI_SIG_CEDENDTX          | \
                                          IFX_TAPI_SIG_V8BISTX           )

#define IFX_TAPI_SIG_EXT_TXMASK (                                          \
           IFX_TAPI_SIG_EXT_V21L        | IFX_TAPI_SIG_EXT_V21LTX        | \
           IFX_TAPI_SIG_EXT_V18A        | IFX_TAPI_SIG_EXT_V18ATX        | \
           IFX_TAPI_SIG_EXT_V27         | IFX_TAPI_SIG_EXT_V27TX         | \
           IFX_TAPI_SIG_EXT_BELL        | IFX_TAPI_SIG_EXT_BELLTX        | \
           IFX_TAPI_SIG_EXT_V22         | IFX_TAPI_SIG_EXT_V22TX         | \
           IFX_TAPI_SIG_EXT_V22ORBELL   | IFX_TAPI_SIG_EXT_V22ORBELLTX   | \
           IFX_TAPI_SIG_EXT_V32AC       | IFX_TAPI_SIG_EXT_V32ACTX       )
...
IFX_int32_t TAPI_Phone_PCM_Get_Activation      (TAPI_CONNECTION *pChannel, IFX_boolean_t *pbAct);
...
IFX_void_t TAPI_Signal_Event_Update            (TAPI_CONNECTION *pChannel, IFX_uint32_t signal, IFX_uint32_t signal_ext);
...
/* ======================================== */
IFX_return_t TAPI_LL_TestLoop                   (TAPI_CONNECTION *pChannel, IFX_TAPI_TEST_LOOP_t* pLoop);
...
IFX_return_t  TAPI_LL_Phone_AGC_Enable         (TAPI_CONNECTION *pChannel, IFX_TAPI_ENC_AGC_MODE_t Param);
IFX_return_t  TAPI_LL_Phone_AGC_Cfg            (TAPI_CONNECTION *pChannel, IFX_TAPI_ENC_AGC_CFG_t *pParam);
#if 0
