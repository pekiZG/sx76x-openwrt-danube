...
extern IFX_int32_t Dsp_SetDtmfRec       (VINETIC_CHANNEL const *pCh,
...
extern IFX_int32_t Dsp_SetNeLec_Pcm     (VINETIC_CHANNEL *pCh, IFX_boolean_t bEnLec,
                                         IFX_boolean_t bEnNlp, IFX_boolean_t bEnWLec);
extern IFX_int32_t Dsp_SigReset         (VINETIC_DEVICE *pDev, IFX_uint8_t ch);
extern IFX_int32_t Dsp_SigActStatus     (VINETIC_DEVICE *pDev, IFX_uint8_t ch,
                             IFX_boolean_t bOn,
                             IFX_int32_t (*pCmdWrite) (VINETIC_DEVICE *pDev,
                                       IFX_uint16_t* pCmd, IFX_uint8_t count));
extern IFX_int32_t Dsp_UpdateEventTrans (VINETIC_DEVICE *pDev, IFX_uint8_t ch,
...
extern IFX_int32_t Dsp_SetCidRec        (VINETIC_CHANNEL const *pCh,
                                         ...
                                         IFX_boolean_t bEn);
#endif /* TAPI_CID */
extern IFX_int32_t Dsp_MFTD_SigEnable   (VINETIC_CHANNEL *pCh,
                                         IFX_uint32_t nSignal,
                                         IFX_uint32_t nSignalExt);
extern IFX_int32_t Dsp_MFTD_SigDisable  (VINETIC_CHANNEL *pCh,
                                         IFX_uint32_t nSignal,
                                         IFX_uint32_t nSignalExt);
#endif /* TAPI */
