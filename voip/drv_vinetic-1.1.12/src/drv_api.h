...
/**
 ...
 - ADDED_SUPPORT - enables features used for system bring up
 - EMULATION    - VINETIC-4M emulation add-on
 ...
 - NO_DATA_WIRING - no data channel is connected to analog channel on
   TAPI initialization. Use of interface IFX_TAPI_MAP_DATA_ADD is needed
   to have a working setup for VoIP for example
 - VIN_SIGALM_FIXED - use of ALM and signaling module connection for
   conferencing, deprecated. Currently there is a new implementation
   which connects the signaling to the coder module. Conferencing is not
   yet tested for the new implementation. */
