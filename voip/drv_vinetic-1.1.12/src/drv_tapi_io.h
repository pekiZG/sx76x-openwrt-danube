...
*/
#define IFX_TAPI_CID_SIZE_MAX                  (128)
...
typedef struct _IFX_TAPI_CH_STATUS
{
   ...
   /** Signals the detection of events.
      ...
      according to the definition of \ref IFX_TAPI_SIG_t. Following
      description is taken from the definition of \ref IFX_TAPI_SIG_t.
