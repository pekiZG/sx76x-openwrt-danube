...
typedef struct
{
   /** measuring channel number [0..n-1] */
   IFX_uint8_t                      nChannel;
	/** underlying VINETIC device revision number */
   IFX_uint8_t								nChip;
	/** underlying SLIC type version number */
   IFX_uint8_t								nSlic;
	/** measurement status/error number */
