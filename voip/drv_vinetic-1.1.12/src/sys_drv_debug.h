 ...
 ****************************************************************************
   ...
   Date        : $Date: 2004/10/13 15:48:53 $
   Description : system debug interface

   $Log: sys_drv_debug.h,v $
   Revision 1.15  2004/10/13 15:48:53  rah
   warning removed (void parameter in empty function parameter list)
...
****************************************************************************/
#define TRACE(name,level,message) do {if(/*level >= G_nTraceGroup##name*/1) \
