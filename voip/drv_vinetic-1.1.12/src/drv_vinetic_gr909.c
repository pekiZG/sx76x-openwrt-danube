...
#define HPT_W2G_AC_LIM_DEFAULT         0x24A4 /* 50 Vrms */
#define HPT_W2W_AC_LIM_DEFAULT         0x245F /* 50 Vrms */
#define HPT_W2G_DC_LIM_DEFAULT         0x4598 /* 135 V */
#define HPT_W2W_DC_LIM_DEFAULT         0x4570 /* 135 V */
#define FEMF_W2G_AC_LIM_DEFAULT        0x0754 /* 10 Vrms */
#define FEMF_W2W_AC_LIM_DEFAULT        0x0746 /* 10 Vrms */
#define FEMF_W2G_DC_LIM_DEFAULT        0x02BF /* 6 V */
#define FEMF_W2W_DC_LIM_DEFAULT        0x0316 /* 6 V */
#define RFT_RES_LIM_DEFAULT            0x20E2 /* 150 KOhm */
#define ROH_LIN_LIM_DEFAULT            0x000F /* 15% */
#define RIT_LOW_LIM_DEFAULT            0x013B /* 1395 Ohm, set for 20 Hz */
#define RIT_HIGH_LIM_DEFAULT           0x231B /* 39860 Ohm, set for 20 Hz */
