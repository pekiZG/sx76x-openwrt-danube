...
Return:
   none
*******************************************************************************/
IFX_void_t TAPI_Phone_Event_Line(TAPI_CONNECTION *pChannel, TAPI_LINESTATUS stat)
{
   switch (stat)
   {
      case  TAPI_LINESTATUS_FEEDLOWBATT:
...
Arguments:
   pChannel    - handle to TAPI_CONNECTION structure
   error       - error according to TAPI_ERROR enum.
Return:
   none
*******************************************************************************/
