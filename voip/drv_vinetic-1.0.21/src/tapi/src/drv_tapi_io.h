...
/** Enumeration for \ref TAPI_RTP_CONF event generation setting */
typedef enum
{
...
/** Enumeration for \ref TAPI_RTP_CONF event playout setting */
typedef enum
{
   /** Device default setting */
   TAPI_RTPEVPLAY_DEFAULT = 0,
   /** All RFC2833 event packet coming from the net are played out */
   TAPI_RTPEVPLAY_PLAY = 1,
   /** All RFC2833 event packet coming from the net are discarded */
   TAPI_RTPEVPLAY_MUTE = 2
}TAPI_RTPEVPLAY;

/** Structure for RTP Configuration used by \ref IFXPHONE_RTP_CONF
    */
typedef struct
{
   ...
   /** Defines how events are transmitted that are detected on the analog line
   ...
   - 0: TAPI_RTPEVPLAY_DEFAULT, Default
   - 1: TAPI_RTPEVPLAY_PLAY, Play out RFC2833 packets coming from the net
   - 2: TAPI_RTPEVPLAY_MUTE, Mute RFC2833 packets coming from the net */
...
typedef enum
{
   ...
   TAPI_RFC2833_EVENT_NO_EVENT   = 0x7FFFFFFF
}TAPI_RFC2833_EVENT;
