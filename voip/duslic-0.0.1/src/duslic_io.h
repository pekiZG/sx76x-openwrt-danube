...
#define DUS_IO_INIT_DEFAULT      0
#define DUS_IO_INIT_NO_CRAM_DWLD 1
#define DUS_IO_INIT_IO_EMUL      2
#define DUS_IO_INIT_TEST1        4
#define DUS_IO_INIT_TEST2        8
