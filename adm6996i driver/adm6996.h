...
#define DANUBE_PPE32_DATA_MEM_MAP_REG_BASE   (LQ_PPE32_BASE_ADDR + (0x4000 * 4))
...
#define ADM_SW_HISE   	    0x0C // Hardware IGMP Snooping Enabled.
#define ADM_SW_ASC   	    0x0B // Additional snooping Control 

/*portmap for IGMP membership Table */
#define IGMP_PORT_1	 0x10
#define IGMP_PORT_2	 0x08
#define IGMP_PORT_3	 0x04
#define IGMP_PORT_4	 0x02
#define IGMP_PORT_5	 0x00
#define IGMP_PORT_UNKNOWN 0xFF
#define PORT1		 1
#define PORT2		 2
#define PORT3		 3
#define PORT4		 4
...
//B.Bogaerts Siemens IGMP snooping
...
int adm_find_membership (int* entry, unsigned short port, unsigned short group, unsigned short group1);
